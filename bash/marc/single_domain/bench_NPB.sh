...
MARC_CFG=$HOME/vm/wheezy/marc.cfg
...
CURRENT_FOLDER=$TESTS_FOLDER/bench-NBP-$NOW
...
sudo xl vcpu-pin marc-wheezly 0 1
...
ssh root@10.0.0.4 'screen -d -m /home/marc/NPB.sh'
echo $(date +%s.%N) " - Command sent"

sleep 4200s

echo $(date +%s.%N) " - Stopping domain marc..."
ssh root@10.0.0.4 'sudo halt'
